                ...
                <div className="container-fluid">
                    ...
                    <div className="d-flex">
                        <select id="genere-filter" className="form-select" aria-label="Default select example" defaultValue="All generes">
                            <option value="all-generes">All generes</option>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <form className="d-flex" role="search">
                                <input id="search-bar" className="form-control me-3" type="search" placeholder="title" aria-label="Search" />
                                <button id="search-button" className="btn" type="submit">Search</button>
                            </form>
                        </div>
                    </div>
                </div>
